  ...
  return (
    <div className="flex min-h-screen flex-col">
      <div className="relative h-[320px] w-full">
        <Image src={gift.image} alt={gift.name} fill sizes="480px" className="object-cover" />
        <button
          onClick={() => router.back()}
          aria-label="Go back"
      ...
      <div className="sticky bottom-0 mt-auto flex items-center gap-3.5 border-t border-beige bg-white px-5 pb-6 pt-3.5 shadow-[0_-2px_8px_rgba(60,36,21,0.03)]">
        ...
        <button
          onClick={() => {
            addItem({ id: gift.id, name: gift.name, price: gift.price, image: gift.image }, qty);
            router.push("/cart");
          }}
